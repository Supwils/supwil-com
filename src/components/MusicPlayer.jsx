...
const MusicPlayer = () =>
{
    ...
    return (
        <div className="fixed bottom-50 right-50 z-[100]">
            {/* Music Icon */}
            <button
                className="fixed bottom-5 right-5 w-20 h-20 rounded-full bg-[var(--main-color)] text-white text-2xl flex items-center justify-center cursor-pointer border-none z-[101] shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg"
